...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="RiskifiedBeacon",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
typedef SWIFT_ENUM(NSInteger, OtpEnv, open) {
  OtpEnvProduction = 0,
  OtpEnvSandbox = 1,
  OtpEnvStaging = 2,
};
...
SWIFT_CLASS("_TtC15RiskifiedBeacon6OtpSdk")
@interface OtpSdk : NSObject
- (void)offerOtpWithConfig:(OtpConfig * _Nonnull)config;
